"""DWA Planning Control launcher for Auto RC Car."""
...
def generate_launch_description():
    ...
    dwa_planning_control_node = Node(
        package="autorccar_planning_control",
        executable="dwa_planning_control_node",
        name="dwa_planning_control",
        parameters=[
    ...
    ld.add_action(dwa_planning_control_node)
